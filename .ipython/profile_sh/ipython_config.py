...
#c.InteractiveShellApp.exec_files = [ 'custom_prompt.py' ]
...
#c.TerminalInteractiveShell.prompts.prompt_in1 = r'{color.LightGreen}\u@\h{color.LightBlue}[{color.LightCyan}\Y1{color.LightBlue}]{color.Green}|\#> '
#c.TerminalInteractiveShell.prompts.prompt_in2 = r'{color.Green}|{color.LightGreen}\D{color.Green}> '
#c.TerminalInteractiveShell.prompts.prompt_out = r'<\#> '
c.AliasManager.user_aliases = [
 ...
 ('fgrep', 'fgrep --color'),
 ('egrep', 'egrep --color'),
 ('pastebinit', 'pastebinit -b https://paste.akawolf.org'),
]
